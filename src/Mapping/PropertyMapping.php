...
use DevFarm\FilesUploaderBundle\Naming\DirectoryNamerInterface;
use DevFarm\FilesUploaderBundle\Naming\NamerInterface;
...
class PropertyMapping
{
    ...
    public function readProperty($obj, $property)
    {
        ...
        if (\is_array($this->propertyPaths[$property])) {
            return null;
        }
    ...
    /**
     * Gets the configured dimensions property name.
     *
     * @return array The dimensions
     */
    public function getDimensionsPropertyName(): array
    {
        return $this->propertyPaths['dimensions'];
    }
